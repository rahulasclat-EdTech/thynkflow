...
const navItems = [
  ...
  { to: '/product-analytics', label: 'Product Analytics', icon: '📊', adminOnly: false },
  ...
  { to: '/registration-integration', label: 'Registration Sync', icon: '🏫', adminOnly: true },
  ...
  { to: '/status-change', label: 'Status Changes', icon: '🔄', adminOnly: false },
